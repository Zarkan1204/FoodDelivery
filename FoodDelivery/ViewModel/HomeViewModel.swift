...
class HomeViewModel: ObservableObject {
    ...
    @Published var products: [Product] = [
        ...
        Product(type: .Pizza, title: "Gribs", prise: "$10", productImage: "gribs"),
        Product(type: .Pizza, title: "Assorty", prise: "$15", productImage: "assorty"),
        Product(type: .Pizza, title: "4 Cheese", prise: "$12", productImage: "4cheese"),
        Product(type: .Pizza, title: "Margarita", prise: "$10", productImage: "margarita"),
        
        Product(type: .Burgers, title: "Chickenburger", prise: "$10", productImage: "chickenburger"),
        Product(type: .Burgers, title: "Gamburger", prise: "$7", productImage: "gamburger"),
        Product(type: .Burgers, title: "Cheeseburger", prise: "$8", productImage: "сheeseburger"),
        Product(type: .Burgers, title: "Bigmak", prise: "$12", productImage: "bigmak"),
        Product(type: .Burgers, title: "Fishburger", prise: "$8", productImage: "fishburger"),
        Product(type: .Burgers, title: "Royalburger", prise: "$10", productImage: "royalburger"),
